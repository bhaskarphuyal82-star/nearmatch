...
const UserMap = dynamic(() => import('@/components/admin/UserMap'), {
    ssr: false,
    loading: () => <div className="h-[600px] w-full bg-zinc-900 rounded-2xl animate-pulse" />
});
        ...
        <div className="space-y-6">
            ...
            <div className="flex bg-zinc-900 p-1 rounded-xl border border-zinc-800">
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${viewMode === 'map'
                        ? 'bg-zinc-800 text-white shadow-sm'
                        : 'text-zinc-400 hover:text-zinc-300'
                        }`}
                >
