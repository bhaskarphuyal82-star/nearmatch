...
import { Heart, Loader2, Lock, CheckCircle, AlertCircle } from 'lucide-react';
...
function ResetPasswordForm() {
    ...
    if (!token) {
        return (
            <div className="text-center p-8 bg-zinc-900/50 rounded-3xl border border-white/5">
                ...
                <Link
                    ...
                    className="inline-block px-6 py-3 rounded-xl bg-zinc-800 text-white font-bold hover:bg-zinc-700 transition-colors"
                >
                    Request New Link
                </Link>
            </div>
            ...
            <div className="bg-zinc-900/50 backdrop-blur-xl border border-white/5 rounded-3xl p-8 shadow-2xl">
                {success ? (
                    ...
                    >
                        ...
                        <Link
                            href="/login"
                            className="block w-full py-3.5 rounded-xl bg-zinc-800 text-white font-bold hover:bg-zinc-700 transition-colors"
                        >
                            Login Now
                        </Link>
                    </motion.div>
