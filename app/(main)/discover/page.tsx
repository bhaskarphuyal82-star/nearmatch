                    ...
                    >
                        ...
                        <form onSubmit={handleLocationSearch} className="flex gap-2">
                            ...
                            <button
                                ...
                                className="px-4 py-3 rounded-xl bg-pink-500 text-white font-medium hover:bg-pink-600 disabled:opacity-50 transition-colors"
                            >
                        ...
                        <button
                            ...
                            className="mt-4 w-full py-3 rounded-xl border border-zinc-700 text-zinc-300 hover:bg-zinc-800 flex items-center justify-center gap-2 transition-colors"
                        >
        ...
        <div className="relative h-[calc(100vh-5rem)] overflow-hidden">
            ...
            <div className="absolute top-0 left-0 right-0 z-20 p-4 flex items-center justify-between">
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-full bg-zinc-900/40 backdrop-blur-md border border-white/5"
                >
                    <MapPin className="w-3 h-3 text-pink-500" />
                    <span className="text-sm font-bold text-white">
                        {customLocation ? customLocation.name : 'Nearby'}
                    </span>
                </button>
