...
import { SlidersHorizontal, MapPin, Loader2, MessageCircle, X, Heart, Briefcase, GraduationCap, Search, Sparkles } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-zinc-950 pb-20 p-4 md:p-8 relative">
            ...
            <p className="text-zinc-400 text-sm mb-6">
                Good vibes and great chats start here. Chat now, make friends.
            </p>
            ...
            {featuredUser && (
                <div className="mb-8 flex flex-col items-center">
                    ...
                    <p className="text-zinc-400 text-center text-sm mb-4 max-w-xs">
                        There&apos;s no need to wait for a connection — you can message them straight away
                    </p>
            ...
            {loading && users.length === 0 ? (
                ...
                <div className="flex flex-col items-center justify-center h-[60vh] text-center px-8">
                    ...
                    <p className="text-zinc-400 max-w-sm">
                        {customLocation
                            ? `No people found around ${customLocation.name}. Try expanding your search distance or changing filters.`
                            : "You've seen everyone nearby. Try changing your filters to see more people."}
                    </p>
                    <button
                        onClick={() => setShowFilters(true)}
                        className="mt-6 px-8 py-3 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full text-white font-bold shadow-lg shadow-pink-500/20"
                    >
                        Change Filters
                    </button>
                </div>
